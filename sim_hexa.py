...
if args.mode == "frozen-direct":
    ...
    # alphas = kinematics.compute_dk(0, 0, 0, use_rads=True)
    alphas = kinematics.compute_dk(0, 0, 0)
...
while True:
    ...
    if args.mode == "frozen-direct":
        ...
        points = kinematics.compute_dkDetailed(
            targets["j_c1_rf"],
            targets["j_thigh_rf"],
            targets["j_tibia_rf"],
            use_rads=True,
        ...
        try:
            ...
            continue
        # alphas = kinematics.compute_ik(x, y, z, verbose=True, use_rads=True)
        alphas = kinematics.compute_ik(x, y, z)
        

        # dk0 = kinematics.compute_dk(0, 0, 0, use_rads=True)
        dk0 = kinematics.compute_dk(0, 0, 0)
